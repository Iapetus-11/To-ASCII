...
try:
    ...
    GrayscaleConverterNim = unsupported_extension("grayscale_converter_nim.GrayscaleConverterNim", e)

try:
    from .extensions.html_color_converter_nim import HtmlColorConverterNim
except Exception as e:
    HtmlColorConverterNim = unsupported_extension("html_color_converter_nim.HtmlColorConverterNim", e)
